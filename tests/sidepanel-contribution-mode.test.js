...
const inputHostedCheckoutVerificationPopupDelaySeconds = { value: '20' };
...
test('contribution mode manager enters mode, starts main auto flow, polls contribution status, and exits cleanly', async () => {
  ...
  const manager = api.createContributionModeManager({
    ...
    constants: {
      ...
      guideRepositoryUrl: 'https://github.com/CatfishW/YanAutoPlus',
      pollIntervalMs: 2500,
    },
  });
  ...
  assert.deepStrictEqual(openedUrls, ['https://github.com/CatfishW/YanAutoPlus']);
