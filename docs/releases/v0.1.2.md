...
- 根据 [Issue #14](https://github.com/CatfishW/YanAutoPlus/issues/14) 的建议，新增账单金额检测与自动停止，降低异常账单继续执行的风险
- 根据 [Issue #8](https://github.com/CatfishW/YanAutoPlus/issues/8) 的建议，新增 `cloud-mail` 适配
